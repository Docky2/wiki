...
insert into `demo`(id,name,password) values(1,'demo','demo');
...
insert into `category`(id,parent,name,sort) values (401,400,'MySQL',400);
...
insert into `user` (`id`,`username`,`name`,`password`) values(1,'test','测试','test')
